...
import net.bytew.demostore.service.CartService;
...
public class CartController {
	...
	public ModelAndView showCart(@RequestParam(name = "result", required = false) String result) {
		...
		if(result!=null) {
			switch(result) {
				case "added":
					mv.addObject("message", "Product has been successfully added to shopping cart!");					
					cartService.validateCartLine();
					break;
				case "unavailable":
					mv.addObject("message", "The specified quantity is not available!");					
					break;
				case "updated":
